...
See [CONTRIBUTING.MD](https://github.com/dvlpjrs/guMCP/blob/main/CONTRIBUTING.MD) for detailed authentication implementation guidelines.
...
<CardGroup cols={2}>
  <Card title="Server Documentation" icon="book" href="https://github.com/dvlpjrs/guMCP/tree/main/src/servers">
