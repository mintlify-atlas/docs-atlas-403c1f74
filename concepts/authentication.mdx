...
- Explore [OAuth utility functions](https://github.com/gumloop/guMCP/tree/main/src/utils/oauth) in the source
- Review [example implementations](https://github.com/gumloop/guMCP/tree/main/src/utils) (Slack, Attio, Airtable)
- Learn about [Transports](/concepts/transports) for securing SSE connections
- See the [CONTRIBUTING.md](https://github.com/gumloop/guMCP/blob/main/CONTRIBUTING.MD) guide for detailed OAuth setup