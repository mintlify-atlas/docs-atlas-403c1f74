...
- **Add Support for New MCP Spec**
  - [Streamable HTTP Transport](https://github.com/dvlpjrs/guMCP/issues/26)
  - Client/Server Authentication Mechanism
- **[Add Support for FastMCP](https://github.com/dvlpjrs/guMCP/issues/24)**
...
- Open an issue in the [GitHub repository](https://github.com/dvlpjrs/guMCP/issues)
