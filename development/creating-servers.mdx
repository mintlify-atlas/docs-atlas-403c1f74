...
- **[Slack](https://github.com/dvlpjrs/guMCP/blob/main/src/utils/slack/util.py)** - OAuth 2.0 without refresh tokens
- **[Attio](https://github.com/dvlpjrs/guMCP/blob/main/src/utils/attio/util.py)** - OAuth 2.0 with refresh tokens and additional params
- **[Airtable](https://github.com/dvlpjrs/guMCP/blob/main/src/utils/airtable/util.py)** - OAuth 2.0 with refresh tokens and PKCE
